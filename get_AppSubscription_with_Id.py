...
def test_check_content_type_equals_json():
    response = requests.get("http://127.0.0.1:8080/mec_service_mgmt/v1/subscriptions?teste=teste")
...
def test_check_status_code_equals_404():
    response = requests.get("http://127.0.0.1:8080/mec_service_mgmt/v1/service/xxx")
